...
public class AdapterRatedProduct extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterRatedProduct(Context context, List<Product> items) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.rated_product_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.price.setText(CurrencyFormat.format(p.getPrice()));
